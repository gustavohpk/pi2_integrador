...
INSERT INTO `event` (`id_event`, `id_parent_event`, `id_event_type`, `name`, `details`, `teacher`, `local`, `start_date`, `end_date`, `spaces`, `id_payment_type`, `start_date_enrollment`, `end_date_enrollment`) VALUES
...
--
-- Restrições para a tabela `enrollment`
--
ALTER TABLE `enrollment`
  ADD CONSTRAINT `fk_enrollment_event` FOREIGN KEY (`id_event`) REFERENCES `event` (`id_event`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_enrollment_participant` FOREIGN KEY (`id_participant`) REFERENCES `participant` (`id_participant`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_enrollment_payment_type` FOREIGN KEY (`id_payment_type`) REFERENCES `payment_type` (`id_payment_type`) ON DELETE NO ACTION ON UPDATE NO ACTION;
