...
<html lang="pt-br">
	...
	<body>
		<div class="container">
			...
			<div class="row">
				<div id="content" class="col-lg-12 col-xs-12 col-sm-12 col-md-12 container">
					<div class="row">
              ...
              <ul class="nav navbar-nav account-menu">
                ...
                <li><a id="btn-media-videos" href="#">VÍDEOS</a></li>
						...
						<div id="media-photos" class="row" style="display:none">
					        ...
					        <div id="progressbar1" aria-valuemax="100" aria-valuemin="100" aria-valuenow="100" class="progress-bar progress-bar-default" role="progressbar" style="width: 100%">
					        	Carregando...
