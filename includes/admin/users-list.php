<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 users-list" style="display:none">
	<div class="panel panel-default">
		<div class="panel-heading">
	    <h3 class="panel-title">Lista de usuários cadastrados</h3>
	  </div>
	  <div class="panel-body">
		...
		<table class="table">
			...
			<tr>
				<td>1</td>
				<td>Gustavo Henrique Pchek Kwaczynski</td>
				<td>ghpk88@gmail.com</td>
				<td>
