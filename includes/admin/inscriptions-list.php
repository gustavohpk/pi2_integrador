<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 inscriptions-list" style="display:none">
	<div class="panel panel-default">
		<div class="panel-heading">
	    <h3 class="panel-title">Lista de inscrições</h3>
	  </div>
